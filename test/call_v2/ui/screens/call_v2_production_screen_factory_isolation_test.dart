...
void main() {
  test('factory source uses only canonical Phase 6D route names', () {
  ...
  test('factory source has no navigation, backend, RTC, or async work', () {
    final source = _factorySources();
  ...
  test('real app files remain isolated and rollout remains false', () {
    ...
    expect(main, isNot(contains('CallV2ProductionScreenFactory')));
    expect(router, isNot(contains('CallV2ProductionScreenFactory')));
...
String _factorySources() {
  return <String>[
    'lib/call_v2/ui/shells/call_v2_production_shell_factory.dart',
    'lib/call_v2/ui/shells/call_v2_production_shell_factory_result.dart',
